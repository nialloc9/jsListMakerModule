!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={i:moduleId,l:!1,exports:{}};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.l=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.i=function(value){return value},__webpack_require__.d=function(exports,name,getter){Object.defineProperty(exports,name,{configurable:!1,enumerable:!0,get:getter})},__webpack_require__.n=function(module){var getter=module&&module.__esModule?function(){return module.default}:function(){return module};return __webpack_require__.d(getter,"a",getter),getter},__webpack_require__.o=function(object,property){return Object.prototype.hasOwnProperty.call(object,property)},__webpack_require__.p="",__webpack_require__(__webpack_require__.s=4)}([function(module,exports,__webpack_require__){var list=function(){function addToList(listItem){var item="string"==typeof listItem?listItem:$input.val();list.push(item),_render(),pubsub.publish("listChanged",list.length),$input.val("")}function deleteFromList(e){var i;if("number"==typeof e)i=e;else{var $remove=$(e.target).closest("li");i=$ul.find("li").index($remove)}list.splice(i,1),_render(),pubsub.publish("listChanged",list.length)}function subscribe(functionName){pubsub.subscribe("listChanged",functionName)}function unsubscribe(functionName){pubsub.unsubscribe("listChanged",functionName)}function returnList(){return list}function _render(){$ul.html(Mustache.render(template,{list:list}))}var $=__webpack_require__(1),Mustache=__webpack_require__(2),pubsub=__webpack_require__(3),list=["a","b"],$el=$("#addToListModule"),$input=$el.find("input"),$btn=$el.find("#addToListBtn"),$ul=$el.find("ul"),template=$el.find("#addToListTemplate").html();return $btn.on("click",addToList),$ul.on("click","i.del",deleteFromList),_render(),{addToList:addToList,deleteFromList:deleteFromList,subscribe:subscribe,unsubscribe:unsubscribe,returnList:returnList}}();module.exports=list},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
